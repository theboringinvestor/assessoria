...
PATHS = {
 ...
 'clapper':   '<path d="M3 9.6h18v9.8a1.6 1.6 0 0 1-1.6 1.6H4.6A1.6 1.6 0 0 1 3 19.4Z"/><path d="m3.4 9.6 1.2-4.6 16 1.6-.8 3"/><path d="m8.6 5.2-.9 4.4"/><path d="m13.8 5.7-.9 3.9"/>',
 ...
 'plane':     '<path d="M10.4 20.6 12 15.4l7.6-1.9a1.9 1.9 0 0 0 0-3.6L3.4 5.2l2.4 6.4-2.4 1.5 2.4 2.3 1.8-1.1Z"/>',
 ...
 'microscope':'<path d="M8.4 18.4h11.2"/><path d="M11.6 18.4a5.6 5.6 0 0 0 5-8.1"/><path d="m9.4 4.4 4.6 2.6-3 5.2-4.6-2.6Z"/><path d="m7.4 9.6-1.6 2.8 4.6 2.6 1.6-2.8"/>',
 ...
 'theater':   '<path d="M4 5.4h8.4v6.4a4.2 4.2 0 0 1-8.4 0Z"/><path d="M8.6 15.6a4.2 4.2 0 0 0 8.2-1.3V7.9"/><path d="M12.4 6.2H20v6.4"/>',
